package com.zychen027.meteorplusplus.modules.elytracollectutils.pathfinder.commands;
                        ...
                        .then(ClientCommandManager.argument("Name", StringArgumentType.string())
                                ...
                                .executes(context -> { // With name
                                    ...
                                    minecraftClient.player.sendMessage(Text
                                            .translatable("text.pathfinder.flylocationFail.notFound", locationName)
                                            ...
                                            if (minecraftClient.player.isGliding()) { // If the player is flying
                                                if (ElytraAutoPilot.groundheight > ModConfig.INSTANCE.minHeight) { // If
                                                    ...
                                                    context.getSource().sendFeedback(Text
                                                            .translatable("text.pathfinder.flyto",
                                                                    ElytraAutoPilot.argXpos, ElytraAutoPilot.argZpos)
                                                            .formatted(Formatting.GREEN));
                                                } else {
                                                    minecraftClient.player.sendMessage(Text
                                                            .translatable("text.pathfinder.autoFlightFail.tooLow")
                                                            .formatted(Formatting.RED), true);
                                                }
                                            } else {
                                                minecraftClient.player.sendMessage(Text
                                                        .translatable("text.pathfinder.flytoFail.flyingRequired")
                                                        .formatted(Formatting.RED), true);
                                            }
                                            return 1;
                                        })))));
                                ...
                                .then(ClientCommandManager.argument("Name", StringArgumentType.string())
                                        ...
                                        .executes(context -> {
                                            ...
                                            for (String s : ModConfig.INSTANCE.flyLocations) {
                                                try {
                                                    ...
                                                    if (location.Name.equals(locationName)) {
                                                        ...
                                                        minecraftClient.player.sendMessage(Text
                                                                .translatable("text.pathfinder.flylocation.removed",
                                                                        locationName)
                                            ...
                                            minecraftClient.player.sendMessage(
                                                    Text.translatable("text.pathfinder.flylocationFail.notFound",
                                        ...
                                        .then(ClientCommandManager
                                                ...
                                                .then(ClientCommandManager
                                                        ...
                                                        .executes(context -> {
                                                            ...
                                                            for (String s : ModConfig.INSTANCE.flyLocations) {
                                                                try {
                                                                    ...
                                                                    if (location.Name.equals(locationName)) {
                                                                        minecraftClient.player.sendMessage(Text
                                                                                .translatable(
                                                                                        "text.pathfinder.flylocationFail.nameExists")
                                                                                .formatted(Formatting.RED), true);
                                                                        return 0;
                                                                    }
                                                            ...
                                                            minecraftClient.player.sendMessage(Text
                                                                    .translatable(
                                                                            "text.pathfinder.flylocation.saved",
                        ...
                        .executes(context -> {
                            if (ElytraAutoPilot.autoFlight) {
                                ...
                                if (player == null)
                                    return 0;
                                player.sendMessage(
                                        Text.translatable("text.pathfinder.landing").formatted(Formatting.BLUE),
                                        true);
